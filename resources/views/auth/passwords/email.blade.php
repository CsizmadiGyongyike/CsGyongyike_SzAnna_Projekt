            ...
            <div class="card-body">
                <div class="auth-body">
                    <div class="form-container">
                        <h4 style="color: #c3ff00; text-align: center;">{{ __('Új jelszó') }}</h4>
                        <hr>
                        <br>

                        @if (session('status'))
                            <div class="alert alert-success" role="alert" style="color: #3cff39; text-align: center; margin-bottom: 15px;">
                                {{ session('status') }}
                            </div>
                        @endif
